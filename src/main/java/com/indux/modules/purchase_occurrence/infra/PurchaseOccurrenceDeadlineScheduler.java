package com.indux.modules.purchase_occurrence.infra;
...
public class PurchaseOccurrenceDeadlineScheduler {
     ...
     */
    @Value("${module.oc.id}")
    private String PURCHASE_MODULE_ID;

    public PurchaseOccurrenceDeadlineScheduler(ModuleManagementService moduleService,
    ...
    public void markOverdueOccurrences() {
        ...
        Modulo finance = moduleService.getModuleByID(UUID.fromString(PURCHASE_MODULE_ID));
        ...
        for (StepModule cfg : finance.getConfigEtapas()) {
            ...
            mongoTemplate.updateMulti(q, u, PurchaseOccurrence.class);
        }
    }
