...
public class Budget {
    ...
    private List<BudgetSolicitante> solicitantes = new ArrayList<>();
    ...
    private List<BudgetDocumento> documentos = new ArrayList<>();
    ...
    private List<StepLogEmbedded> stepLog = new ArrayList<>();
