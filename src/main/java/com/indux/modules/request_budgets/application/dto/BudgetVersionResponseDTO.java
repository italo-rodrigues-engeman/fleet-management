...
public class BudgetVersionResponseDTO {
    private String id;
    ...
    // Comercial
    private List<BudgetComercialResponseDTO> comercial;
    
    // Engenharia
    private List<BudgetEngenhariaResponseDTO> engenharia;
    
    // SMS
    private List<BudgetSmsResponseDTO> sms;
    
    // Operações
    private List<BudgetOperacaoResponseDTO> operacoes;
