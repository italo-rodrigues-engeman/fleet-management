...
@Component
public class OccurrenceDeadlineScheduler {
    ...
    public OccurrenceDeadlineScheduler(ModuleManagementService moduleService,
    ...
    public void markOverdueOccurrences() {
        ...
        Modulo finance = moduleService.getModuleByID(UUID.fromString(FINANCE_MODULE_ID));
        ...
        for (StepModule cfg : finance.getConfigEtapas()) {
            ...
            mongoTemplate.updateMulti(q, u, OcorrenciaFF.class);
        }
    }
